...
case class IndexWithHashRow(term: String, indices: List[Int], hash: java.util.UUID)
case class IndexWithURLRow(term: String, indices: List[Int], url: String)
...
sealed class IndexWithHashTable extends CassandraTable[IndexWithHashTable, IndexWithHashRow]{
  ...
  object indices extends ListColumn[IndexWithHashTable, IndexWithHashRow, Int](this)
...
sealed class IndexWithURLTable extends CassandraTable[IndexWithURLTable, IndexWithURLRow]{
  object term extends StringColumn(this) with PartitionKey[String]
  object indices extends ListColumn[IndexWithURLTable, IndexWithURLRow, Int](this)
